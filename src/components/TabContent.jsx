...
function TabContent({ tabId, member_lv, userGrade, questions, total_pages }) {
  switch (tabId) {
    ...
    case 'mp_tab-3':
      ...
      case 'mp_tab-6' :
        return (
             <div id="mp_tab-6" class="mp_tab-content"><h2 class = 'mp_h2'>탈퇴 하기</h2>
             <div class="mp_output" id="mp_secession"><h2 class = 'mp_h2'>문의할 사항</h2>
                <div class="mp_output" id="mp_questiontext">
                  <textarea name="" cols="80" rows="20" id="mp_question"></textarea>
                  <input type='text'></input>
                    <div id='mp_secessionSpace'>
                    <p class='mp_secession'>아직 공부할 수 있는 문제가 많이 남아있어요!</p>
                    <p class="mp_secession">정말로 탈퇴하실 건가요?</p>
                    <p classname="mp_secession">탈퇴하시면 지금까지 저장된 문제, 구독 정보, 등급이 전부 초기화되고 복구할 수 없습니다!</p>
